...
for i in range(0,len(checked_sources)):
    ...
    if matching_element in all_sources:
        ...
        try:
            total_articles=sum(different_count_set[2:])
...
rank_path="D://Thesis//data//domain_name//news_sources_ranking//ranked_based_on_average_articles//mean_std_category_based.txt"
