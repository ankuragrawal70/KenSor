...
def changerankscrapper(site):
    ...
    #print soup.text
    globalrank = soup.find("strong", { "class" : "metricsUrl font-big2 valign" })
    changerank = soup.find("span", { "class" : "change-wrapper change-up" })
    print globalrank.contents
    print changerank.contents
