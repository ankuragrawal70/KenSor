...
def find_links(link,cate,c_time):
    try :
        ...
        if len(output)>0:
            ...
            pr_link="D://Thesis//data//domain_name//main_category_crawler//valid_links1.txt"
            f_pr=open(pr_link,'a+')
            f_pr.write(link+'\n')
            f_pr.close()
        else:
            print "no links found invalid",link
            inv_path="D://Thesis//data//domain_name//main_category_crawler//invalid_links1.txt"
...
def time_call():
    ...
    while current_time<stop_time:
            ...
            for i in range(48000,len(sources)):
                st = datetime.datetime.now().strftime("%A, %d. %B %Y %I.%M")
...
path1="D://Thesis//data//domain_name//domains_related_to_category_path//main_category//file1.txt"
f_path=open(path1,"r")
